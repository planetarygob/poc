<template>
    <section v-if="isDisplayed">
        ...
        <div class="wrapper">
            <h2>{{ planetContent.title }}</h2>
            <div class="container">
                <div class="text-content">
                    <p>{{ planetContent.paragraphs[0] }}</p>
                    <p>{{ planetContent.paragraphs[1] }}</p>
                    <p>{{ planetContent.paragraphs[2] }}</p>
                </div>
                <div class="img-content">
                    <div class="img img--large">{{ planetContent.images[0] }}</div>
                    <div class="img img--small">{{ planetContent.images[1] }}</div>
                    <div class="img img--small">{{ planetContent.images[2] }}</div>
                </div>
            </div>
            <div class="container">
                <div class="video">{{ planetContent.video }}</div>
            </div>
            <div class="container">
                <div class="text-content">
                    <p>{{ planetContent.paragraphs[3] }}</p>
                </div>
                <div class="text-content">
                    <p>{{ planetContent.paragraphs[4] }}</p>
                </div>
            </div>
    ...
    data() {
        return {
            ...
            planetContent: {
                title : "Jupe",
                paragraphs: [
                    "Née dans les années 1960, la mini-jupe est devenue en France un symbole stylistique célébrant une femme affranchie des codes vestimentaires conservateurs.",
