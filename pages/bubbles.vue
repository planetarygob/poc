...
export default {
    ...
    mounted() {
        ...
        gltfLoader.load('/models/sun_mode_v2.gltf', (gltf) => {
           for (let theme of this.themes) {
                ...
                theme.model.addEventListener('mouseover', () => {
    ...
    methods: {
        ...
        bubbleClicked (bubble, event) {
            ...
            }).call(this.hideOtherBubbles, null, "+1.5")
